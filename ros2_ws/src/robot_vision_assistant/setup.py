...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'qwen_vl_runtime_node = robot_vision_assistant.qwen_vl_runtime_node:main',
            'response_orchestrator_node = robot_vision_assistant.response_orchestrator_node:main',
        ],
    },
)
